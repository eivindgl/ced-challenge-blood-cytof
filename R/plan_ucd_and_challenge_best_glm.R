...
extract_chal_glm_scores <- function(ucd_chal_glm_res_sub_newpanel, ucd_chal_glm_res_sub_oldpanel, 
                                    ucd_chal_glm_res_sub_mixpanel) {
  bind_rows(
...
ucd_save_glm_sub_coeffs <- function(ucd_chal_glm_res_sub_mixpanel, ucd_chal_glm_res_sub_newpanel, 
  ...
  extract_coeffs(ucd_chal_glm_res_sub_mixpanel) %>% 
    writexl::write_xlsx('out/ucd_and_chal_mixpanel_top_N_predictors_sub_markers.xlsx') 
  extract_coeffs(ucd_chal_glm_res_sub_oldpanel) %>% 
    writexl::write_xlsx('out/ucd_and_chal_oldpanel_top_N_predictors_sub_markers.xlsx') 
  extract_coeffs(ucd_chal_glm_res_sub_newpanel) %>% 
    writexl::write_xlsx('out/ucd_and_chal_newpanel_top_N_predictors_sub_markers.xlsx') 
  
  ucd_chal_glm_sub_scores %>% 
    write_xlsx('out/ucd_chal_glm_scores.xlsx')
